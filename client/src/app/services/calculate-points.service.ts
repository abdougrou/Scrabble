...
//  import { GameManagerService } from './game-manager.service';            --UNCOMMENT ONCE PLAYER IS INITIALIZED
...
export class CalculatePointsService {
    //  constructor(private gameManager: GameManagerService) {}             --UNCOMMENT ONCE PLAYER IS INITIALIZED
    ...
    calculatePoints(tileCoords: TileCoords[][], newTiles: TileCoords[]): number {
        ...
        //  this.gameManager.currentPlayer.score += points;                 --UNCOMMENT ONCE PLAYER IS INITIALIZED
        return points;
    }
